...
def getWeather():
    try:
        ...
        pressure = int(json_data['main']['pressure'] - 266)
        ...
        messagebox.showerror("Weather App", "Неправильный ввод!")
...
# label
label1 = Label(root, text="ВЕТЕР м/с", font=("Helvetica", 15, "bold"), fg="white", bg="#1ab5ef")
label1.place(x=120, y=400)

label2 = Label(root, text="ВЛАЖНОСТЬ %", font=("Helvetica", 15, "bold"), fg="white", bg="#1ab5ef")
label2.place(x=250, y=400)

label3 = Label(root, text="ОБЛАЧНОСТЬ", font=("Helvetica", 15, "bold"), fg="white", bg="#1ab5ef")
